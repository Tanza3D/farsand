...
import com.farsand.farsand.protocol.reflect.VolatileField;
...
class PlayerInjector {
     ...
     * @exception InvocationTargetException If an error occured when sending the packet.
     */
    ...
    public void injectManager() {
        ...
        if (networkManager != null) {
            ...
            Object networkProxy = Proxy.newProxyInstance(NetworkManager.class.getClassLoader(),
                    new Class<?>[] { NetworkManager.class }, new InvocationHandler() {
                        @Override
